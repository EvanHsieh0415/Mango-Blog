...
const aHref = computed(() => `https://mcmod.cn/${props.path}`);

const imageAlt = computed(() => `${props.name ?? props.path} mcmod.cn Badge`);
</script>